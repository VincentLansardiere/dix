...
describe('Service Tests', () => {
    ...
    describe('UserEventParticipation Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserEventParticipationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-event-participations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserEventParticipation', () => {
