...
describe('Service Tests', () => {
    ...
    describe('AssociationUserRole Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssociationUserRoleService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/association-user-roles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AssociationUserRole', () => {
